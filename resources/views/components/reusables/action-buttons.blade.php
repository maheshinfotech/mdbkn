<span>
    <div class="d-flex justify-content-start">
        ...
        @can('update', $module)
            ...
            <a href="{{ url(config('app.admin_prefix')."manage-$module/$id") }}" 
                class="btn text-primary" data-bs-toggle="tooltip"  title="Edit Record">
                <i class="fa-solid fa-pen"></i>
            </a>

            @if($module == 'user')
                <button class="btn text-success update-user-credentials" data-id="{{$id}}" data-name="{{$name}}"        
                    data-bs-toggle="tooltip"  title="Update Password" >
        ...
        @can('delete', $module)
            <button data-id="{{ $id }}" data-module="{{ $module }}" data-name="{{ $name }}"
                class="delete-record btn text-danger js-swal-confirm " data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Record">
