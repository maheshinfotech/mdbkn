...
@section('content')
    ...
    <div class="content  mx-0 w-100">
        <div class="container-fluid px-0" style="margin-bottom: 5%">
            <!-- card starts -->
            ...
            <div class="card my-3">
                <div class="card-header bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex">
                            <h3 class="text-purple fw-bold mb-0">Add Booking/Canteen </h3>
                        </div>
                        <div class="d-flex ">
                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                <li class="nav-item " role="presentation">
                                  <button class=" nav-link active" data-bs-toggle="pill" data-bs-target="#add_booking" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Add Booking</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                  <button class=" nav-link"  data-bs-toggle="pill" data-bs-target="#add_canteen" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Add Canteen</button>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="add_booking" role="tabpanel" tabindex="0">
                            <!--form starts -->
                        ...
                        <div class="tab-pane fade" id="add_canteen" role="tabpanel" tabindex="0">
                            <form action="/add-canteen" method="post" class="" enctype="multipart/form-data">
                                @csrf
                                <div class="row align-items-center">
                                    <div class="col-lg-4 col-12 mb-4">
                                        <label class="fs-7 fw-bold mb-1">Name<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-4 col-12 mb-4">
                                        ...
                                        <input type="date" class="form-control" id="" name="startdate" value="" />
                                    </div>

                                    <div class="col-md-4 col-12 mb-4">
                                        <label class="fw-bold mb-1">End Date:</label>
                                        <input type="date" class="form-control" id="" name="enddate" value="" />
                                    </div>
