@php
    ...
    $pageName = 'Group Fuel Summary';

    $tableHead = [ 'Date' , ...$groups->pluck('group_name') , 'Total Consumption'];
...
@section('content')
    ...
    <x-reusables.app-header pageName="{{ $pageName }}" :createButton="false"  />
            ...
            <div class="block-content block-content-full">
                ...
                <form class="row  g-3 align-items-center" >
                    ...
                    <div class="col">
                        ...
                        <a class="btn btn-secondary" href="{{route('group-fuel-summary')}}">Reset</a>
                    </div>
                </form>
                            ...
                            @foreach ($listingData as $data)
                                ...
                                <tr>
                                    ...
                                    @forelse ( $groups as $group)
                                        ...
                                        @php
                                            $fuel_in_liters = $group->fuelConsumption()
                                                                ->whereDate('fuel_consumption_reading.created_at' , date('Y-m-d', strtotime($data->raw_format)) )
                                                                ->sum('fuel_in_liters');
