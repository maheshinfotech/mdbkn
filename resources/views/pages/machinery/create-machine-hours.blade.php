    ...
    <div class="content  mx-0 w-100">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full">
                ...
                <form class="row g-3 align-items-center" action="{{route('mass-insert-machine-hours')}}" enctype="multipart/form-data" method = "POST">
                    @csrf
                    ...
                    <div class = "col-12 text-center gap-2 mt-3">
                        ...
                        <a href="{{asset('excel_data/working-hours.xlsx')}}" class="btn btn-secondary"><i class="fa-solid fa-download"></i> Sample Download</a>
                    </div>
