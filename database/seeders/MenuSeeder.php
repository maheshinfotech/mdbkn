    ...
    public function run()
    {
        ...
        DB::insert(DB::raw(
            " INSERT INTO `menus` (`id`, `menu_name`, `menu_href`, `menu_parent`, `menu_icon`, `menu_placeholder`, `menu_permissions`, `is_active`, `created_at`, `updated_at`, `deleted_at`, `is_section`, `order`)
                ...
                (7, 'permission', 'permissions', 0, '<i class=\"fa-solid fa-person-shelter\"></i>', 'permissions', '1,2,3,4', 1, NULL, NULL, NULL, 0, 4),
                (8, 'role', 'roles', 0, '<i class=\"fa-solid fa-person-shelter\"></i>', 'roles', '1,2,3,4', 1, NULL, NULL, NULL, 0, 4)
                ;"
        ));
    }
}
